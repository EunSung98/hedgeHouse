...
#define DATABASE_URL "hedgeshouse-8f26e-default-rtdb.firebaseio.com"
#define DATABASE_SECRET "OuZ9k6rD2l4IOgGeNwprV7qG2wqDLLEVDzyYzAtm"

/* 1 wifi  */
//#define WIFI_SSID "Hyobin"
//#define WIFI_PASSWORD "11250000"

#define WIFI_SSID "hhyu2"
#define WIFI_PASSWORD ""

//#define WIFI_SSID "hhyu"
//#define WIFI_PASSWORD "10041004"
...
//  Serial.printf("Get int... %s\n",Firebase.getInt(fbdo, F("/cageControl/manual")) ? String(fbdo.to<int>()).c_str() : fbdo.errorReason().c_str()); 
